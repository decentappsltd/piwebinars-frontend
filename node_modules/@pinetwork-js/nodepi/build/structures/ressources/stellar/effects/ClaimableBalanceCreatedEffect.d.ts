 ...
 */
export declare class ClaimableBalanceCreatedEffect extends Effect<EffectTypeNames.claimableBalanceCreated, EffectType.claimable_balance_created> {
    /**
     ...
     */
    balanceId: string;
    constructor(client: Client, data: ClaimableBalanceCreated);
